...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([
        [InlineKeyboardButton("📢 Updates", url="https://t.me/mehedimilon200"),
        InlineKeyboardButton("💬 Support", url="https://t.me/mehedimilon2")],
        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/Mehedimilon20")]
        ])
